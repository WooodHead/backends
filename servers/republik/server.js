...
const { graphql: grantMemberships } = require('@orbiting/backend-modules-grant-memberships')
...
const runOnce = (...args) => {
  ...
  require('@orbiting/backend-modules-grant-memberships').grantsScheduler.init()
}
